...
// import { useEffect, useState } from "react";
// import { useNavigate } from "react-router-dom";
// import { RefreshCw, Calendar, Clock, AlertCircle, Folder, Zap } from "lucide-react";
...
//         {/* Header */}
// <div className="relative overflow-hidden bg-slate-800/40 backdrop-blur-xl rounded-3xl p-6 mb-8 border border-slate-700/40 shadow-lg">
//   {/* Glow accents */}
...
//     <div className="flex items-center gap-4">
//       {/* Info Badge */}
//       <div className="hidden sm:flex items-center gap-2 bg-slate-700/40 px-4 py-2 rounded-xl border border-slate-600/40">
...
//         onClick={load}
//         disabled={loading}
//         className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium shadow-md transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
//       >
...
//         {/* Meetings Table */}
//         {!loading && meetings.length > 0 && (
//           <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl overflow-hidden border border-slate-700/30">
//             <div className="overflow-x-auto">
//               <table className="w-full">
//                 <thead>
//                   <tr className="bg-slate-700/50 border-b border-slate-700/30">
//                     <th className="p-4 pl-6 text-left text-slate-300 font-medium text-sm w-[45%]">
//                       Meeting Title
//                     </th>
...
//                       Time
//                     </th>
//                     <th className="p-4 pr-6 text-left text-slate-300 font-medium text-sm w-[15%]">
//                       Duration
//                     </th>
//                   </tr>
//                 </thead>
...
//                             <div className="w-8 h-8 bg-slate-700/40 rounded-lg flex items-center justify-center flex-shrink-0">
//                               <Folder size={16} className="text-blue-400" />
//                             </div>
...
//                           <span className="bg-slate-700/40 text-slate-200 px-3 py-1.5 rounded-lg text-xs font-medium border border-slate-600/30 inline-block">
//                             {formatDuration(m.duration)}
//                           </span>
//                         </td>
//                       </tr>
...
//         {/* Empty State */}
//         {!loading && meetings.length === 0 && (
//           <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-8 text-center border border-slate-700/30">
//             <div className="w-16 h-16 bg-slate-700/40 rounded-full flex items-center justify-center mx-auto mb-4 border border-slate-600/30">
...
//             <button
//               onClick={load}
//               className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-5 py-2.5 rounded-xl flex items-center gap-2 mx-auto transition-all duration-300"
//             >
//               <RefreshCw size={16} />
//               Try Again
//             </button>
